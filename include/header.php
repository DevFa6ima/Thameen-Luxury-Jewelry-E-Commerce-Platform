...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="../productsPages/cart-page.php"><img src="../assets/header-Icon/Cart.png" height="20" alt="cart"></a><span id="cart-count"><?php echo $cartItemCount; ?></span></li>
    ...
    <script>
        ...
        function updateCartCount() {
            fetch('../productsPages/get-cart-count.php')
