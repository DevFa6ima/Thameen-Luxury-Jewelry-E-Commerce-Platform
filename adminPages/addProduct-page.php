...
if (isset($_POST['addProduct'])) {
    ...
    // Default image path
    $defaultImagePath = '../assets/products-Img/image-Icon.png';
...
<body>
    ...
    <div class="container-between-header-footer">
        ...
        <form method="post" action="" class="adminForm" enctype="multipart/form-data">
            ...
            <input class="btn-secondary" type="submit" name="addProduct" value="Add">
            <input class="btn-primary" type="button" value="Back" onclick="window.location.href='manageProduct-page.php'">
        </form>
    </div>
