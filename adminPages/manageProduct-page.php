...
if(!isset($_SESSION['username'])) { 
    header('location: ../mainPages/login-page.php');
    exit();
    ...
    <div class="container-between-header-footer">
        ...
        <div id="White-Container">
            <div id="white-Container-head"> 
                ...
                <h2>Product list | <span class="text-total"> <?= "Total= $total"?> </span></h2> 
                <div class="font">
                    <input type="search" class="searchInput-AdminPage" id="search_text" placeholder="Search Product.." >
                    <input type="submit" value="   Add Product   " onclick="window.location.href='addProduct-page.php'" class="btn-secondary">
                </div>
            </div>
                            ...
                            <td>
                                <div class="admin-actions">
                                    <form method="post" action="" class="form-reset">
                                        ...
                                        <input type="submit" name="deleteButton" value="Delete" class="btn-primary" onclick="return confirmDelete('<?= $product['name']; ?>');">
                                    </form>
