    ...
    <div class="container-between-header-footer">
        ...
        ?>
                <form method="post" action="" class="adminForm" enctype="multipart/form-data"> <!-- the white contaner-->
                    ...
                    <!-- Actions button-->
                    <input class="btn-secondary" name="saveButton" type="submit" value="Save">
                    <input class="btn-primary" type="button" value="Back" onclick="window.location.href='../adminPages/manageProduct-page.php'">
